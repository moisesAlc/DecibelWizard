...
if __name__ == '__main__':
    ...
    output_path = r'C:\Users\MoisesMadeira\Downloads\Vídeo 00 - Sumário - modificado.mp4'

    increase_volume_in_section(video_path, start_time, end_time, volume_multiplier, output_path)
